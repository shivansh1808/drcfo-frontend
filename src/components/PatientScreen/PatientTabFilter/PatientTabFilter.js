        ...
        <>
          <span>
            <svg width="17" height="17" viewBox="0 0 17 17" fill="none">
              <rect width="17" height="17" fill="url(#pattern101)" />
              <defs>
                <pattern
                  id="pattern101"
    ...
    >
      <div className="filter_modal">
        <div className="filter_header">
          <p onClick={() => setIsOpenFilter(false)}>
        ...
        <div className="patient_type_filter">
          <h2>Patient Type</h2>
          <section className="light request_filter_checkbox_input">
            <label>
              <input
                type="radio"
                value="new"
...
export default PatientTabFilter;
